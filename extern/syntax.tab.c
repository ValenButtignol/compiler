...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TConst = 5,                     /* TConst  */
  YYSYMBOL_TSemiColon = 6,                 /* TSemiColon  */
  YYSYMBOL_TReturn = 7,                    /* TReturn  */
  YYSYMBOL_TAssign = 8,                    /* TAssign  */
  YYSYMBOL_TPlus = 9,                      /* TPlus  */
  YYSYMBOL_TMinus = 10,                    /* TMinus  */
  YYSYMBOL_TMultiply = 11,                 /* TMultiply  */
  YYSYMBOL_TDivide = 12,                   /* TDivide  */
  YYSYMBOL_TOpenParenthesis = 13,          /* TOpenParenthesis  */
  YYSYMBOL_TCloseParenthesis = 14,         /* TCloseParenthesis  */
  YYSYMBOL_TInteger = 15,                  /* TInteger  */
  YYSYMBOL_TBool = 16,                     /* TBool  */
  YYSYMBOL_17_ = 17,                       /* '+'  */
  YYSYMBOL_18_ = 18,                       /* '-'  */
  YYSYMBOL_19_ = 19,                       /* '*'  */
  YYSYMBOL_20_ = 20,                       /* '/'  */
